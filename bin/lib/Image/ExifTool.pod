...
even if some individual tags in the group are not writable.
...
'SRCTAG>DSTTAG' (or 'DSTTAGE<lt>SRCTAG') to be specified to copy information
...
'modifyDate>fileModifyDate' or '*>xmp:*'), and/or suffixed by a '#' to
disable print conversion.  Copied tags may also be added or deleted from a
list with arguments of the form 'SRCTAG+>DSTTAG' or 'SRCTAG->DSTTAG'.  Tags
